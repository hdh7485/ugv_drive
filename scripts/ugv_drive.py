...
class UGVDriver:
    ...
    def odom_calculator(self, event=None):
        wheel_speed_1 = self.front_odrive.vel_estimate_axis0() * math.pi*2/self.cpr
        wheel_speed_2 = self.front_odrive.vel_estimate_axis1()
        wheel_speed_3 = self.back_odrive.vel_estimate_axis0()
        wheel_speed_4 = self.back_odrive.vel_estimate_axis1()
        #rospy.loginfo("wh1:{} wh2:{} wh3:{} wh:{}".format(wheel_speed_1, wheel_speed_2, 
